...
output_train = '/media/data_4T/bran/WMH_dataset/raw/training/utrecht_flair_png/train'
output_test = '/media/data_4T/bran/WMH_dataset/raw/training/utrecht_flair_png/val'
output_check = '/media/data_4T/bran/WMH_dataset/raw/training/utrecht_flair_png/check'
VALIDATION_CENTER = 'Utrecht'
SLICE_THRSHL = 0.16
...
def generate_images(scans_T1, scans_FLAIR, masks):
    ...
    train_masks = [train_mask for train_mask in train_masks if not VALIDATION_CENTER in train_mask]
    print(train_masks)
    ...
    print(test_masks)
    test_masks = [test_mask for test_mask in test_masks if VALIDATION_CENTER in test_mask]
...
with open('/media/data_4T/bran/WMH_dataset/raw/training/utrecht_flair_png/split_train.tsv', 'w') as f:
    for key in merged_split_train.keys():
        f.write("%s\t%s\n"%(key,merged_split_train[key]))     
with open('/media/data_4T/bran/WMH_dataset/raw/training/utrecht_flair_png/split_test.tsv', 'w') as f:
